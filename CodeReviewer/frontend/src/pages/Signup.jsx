      ...
      >
        ...
        <div className="flex gap-3">
          <input
            ...
            required
            className="w-1/2 bg-neutral-800 text-white px-4 py-2.5 rounded-lg outline-none focus:ring-2 focus:ring-indigo-500"
          />
          <input
            type="text"
        ...
        >
          <svg width="18" height="18" viewBox="0 0 18 18">
            ...
            <path
              fill="#34A853"
              d="M9 18c2.43 0 4.47-.81 5.96-2.18l-2.91-2.27c-.81.54-1.84.86-3.05.86-2.35 0-4.34-1.58-5.05-3.71H.96v2.34C2.44 15.98 5.48 18 9 18z"
            />
            <path
              fill="#FBBC05"
              d="M3.95 10.7c-.18-.54-.28-1.11-.28-1.7s.1-1.16.28-1.7V4.96H.96A8.99 8.99 0 000 9c0 1.45.35 2.83.96 4.04l2.99-2.34z"
            />
            <path
              fill="#EA4335"
              d="M9 3.58c1.32 0 2.51.45 3.44 1.35l2.58-2.58C13.46.89 11.43 0 9 0 5.48 0 2.44 2.02.96 4.96l2.99 2.34C4.66 5.16 6.65 3.58 9 3.58z"
            />
          </svg>
          Sign up with Google
        </button>
